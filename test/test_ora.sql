...
ALTER TABLE pgctest."Emp" ADD CONSTRAINT "Emp_pkey" PRIMARY KEY ("EID");

-- EID 5 is missing on Oracle to create mismatch to Postgres.
-- Last_Name has been changed to 'Doe' for EID 1 to create mismatch to Postgres.
Insert into "Emp" (EID,FIRST_NAME,LAST_NAME,EMAIL,HIRE_DT,AGE,"Zip",STATUS,SALARY,LAST_LOGIN,BIO) values (1,'John','Doe','john.doe@example.com',to_date('15-JAN-22','DD-MON-RR'),30,90210,'ACT',60000,to_timestamp('20-AUG-24 09.30.00.000000000 AM','DD-MON-RR HH.MI.SSXFF AM'),'Software Engineer with 5 years of experience.');
Insert into "Emp" (EID,FIRST_NAME,LAST_NAME,EMAIL,HIRE_DT,AGE,"Zip",STATUS,SALARY,LAST_LOGIN,BIO) values (2,'Jane','Smith','jane.smith@example.com',to_date('23-MAY-21','DD-MON-RR'),28,10001,'ACT',65000,to_timestamp('19-AUG-24 02.45.00.000000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'Data Scientist specializing in machine learning.');
Insert into "Emp" (EID,FIRST_NAME,LAST_NAME,EMAIL,HIRE_DT,AGE,"Zip",STATUS,SALARY,LAST_LOGIN,BIO) values (3,'Alice','Johnson','alice.johnson@example.com',to_date('12-NOV-20','DD-MON-RR'),34,30303,'ACT',70000,to_timestamp('18-AUG-24 05.00.00.000000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'Project Manager with a focus on agile methodologies.');
...
Insert into "Emp" (EID,FIRST_NAME,LAST_NAME,EMAIL,HIRE_DT,AGE,"Zip",STATUS,SALARY,LAST_LOGIN,BIO) values (5, 'Charlie', 'Davis', 'charlie.davis@example.com', to_date('2018-03-22','DD-MON-RR'), 45, 94105, 'ACT', 80000.00, to_timestamp('2024-08-16 10:30:00','DD-MON-RR HH.MI.SSXFF AM'), 'Database Administrator with expertise in PostgreSQL.'),
Insert into "Emp" (EID,FIRST_NAME,LAST_NAME,EMAIL,HIRE_DT,AGE,"Zip",STATUS,SALARY,LAST_LOGIN,BIO) values (6,'Eva','Green','eva.green@example.com',to_date('05-SEP-17','DD-MON-RR'),50,33101,'INA',85000,to_timestamp('15-AUG-24 11.45.00.000000000 AM','DD-MON-RR HH.MI.SSXFF AM'),'Security Analyst with 10 years of experience.');
...
Insert into "Emp" (EID,FIRST_NAME,LAST_NAME,EMAIL,HIRE_DT,AGE,"Zip",STATUS,SALARY,LAST_LOGIN,BIO) values (15,'Noah','Scott','noah.scott@example.com',to_date('20-JUL-08','DD-MON-RR'),36,85001,'ACT',65000,to_timestamp('06-AUG-24 11.15.00.000000000 AM','DD-MON-RR HH.MI.SSXFF AM'),'Cloud Engineer with experience in AWS and Azure.');
...
Insert into "Emp" (EID,FIRST_NAME,LAST_NAME,EMAIL,HIRE_DT,AGE,"Zip",STATUS,SALARY,LAST_LOGIN,BIO) values (17,'Paul','Upton','paul.upton@example.com',to_date('09-NOV-06','DD-MON-RR'),35,80202,'ACT',83000,to_timestamp('04-AUG-24 01.00.00.000000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'Sales Manager with a focus on SaaS products.');
...
Insert into "Emp" (EID,FIRST_NAME,LAST_NAME,EMAIL,HIRE_DT,AGE,"Zip",STATUS,SALARY,LAST_LOGIN,BIO) values (20,'Sam','Young','sam.young@example.com',to_date('17-JAN-03','DD-MON-RR'),49,60611,'ACT',91000,to_timestamp('01-AUG-24 05.00.00.000000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'Product Manager with experience in e-commerce.');
...
INSERT INTO pgctest.test_common VALUES (1,1,1,1 ,12345678901234567890,1234567890123456789012345,123.11,123456.1,12345678.1,'abc','A ','when in the course of human events it becomes necessary...', DATE'1970-01-01', TIMESTAMP'1776-07-04 00:00:01', to_timestamp_tz('1776-07-04 00:00:01 -01:00','YYYY-MM-DD HH24:MI:SS.FF6 TZH:TZM'), TIMESTAMP'1776-07-04 00:00:01.123456',  to_timestamp_tz('1776-07-04 00:00:01.123456 -01:00','YYYY-MM-DD HH24:MI:SS.FF6 TZH:TZM'),12345678901234567890123456789012345678,12345678901234567890123456789.123456789,12345678.123456789012345678901234567890);
INSERT INTO pgctest.test_common VALUES (2,2,2,2 ,12345678901234567890,1234567890123456789012345,123.22,123456.2,12345678.2,'',   'B' ,'when in the course of human events it becomes necessary...', DATE'1970-01-02', TIMESTAMP'1991-01-02 00:00:02', to_timestamp_tz('1991-01-02 00:00:02 -02:00','YYYY-MM-DD HH24:MI:SS.FF6 TZH:TZM'), TIMESTAMP'1991-01-02 00:00:02.123456',  to_timestamp_tz('1991-01-02 00:00:02.123456 -02:00','YYYY-MM-DD HH24:MI:SS.FF6 TZH:TZM'),22345678901234567890123456789012345678,22345678901234567890123456789.123456789,22345678.123456789012345678901234567890);
INSERT INTO pgctest.test_common VALUES (3,3,3,3 ,12345678901234567890,1234567890123456789012345,123.3,123456.3,12345678.3 ,'xyx','C ','when in the course of human events it becomes necessary...', DATE'1970-01-03', TIMESTAMP'2030-01-03 00:00:03', to_timestamp_tz('2030-01-03 00:00:03 -03:00','YYYY-MM-DD HH24:MI:SS.FF6 TZH:TZM'), TIMESTAMP'2030-01-03 00:00:03.123456',  to_timestamp_tz('2030-01-03 00:00:03.123456 -03:00','YYYY-MM-DD HH24:MI:SS.FF6 TZH:TZM'),32345678901234567890123456789012345678,32345678901234567890123456789.123456789,32345678.123456789012345678901234567890);