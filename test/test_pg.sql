...
(1,1,1,1 ,12345678901234567890,1234567890123456789012345,123.11,123456.1,12345678.1,'abc','A ','when in the course of human events it becomes necessary...', DATE'1970-01-01', TIMESTAMP'1776-07-04 00:00:01', TIMESTAMP WITH TIME ZONE'1776-07-04 00:00:01 -01:00', TIMESTAMP'1776-07-04 00:00:01.123456 -01:00',  TIMESTAMP WITH TIME ZONE'1776-07-04 00:00:01.123456 -01:00',12345678901234567890123456789012345678,12345678901234567890123456789.123456789,12345678.123456789012345678901234567890),
(2,2,2,2 ,12345678901234567890,1234567890123456789012345,123.22,123456.2,12345678.2,'',   'B' ,'when in the course of human events it becomes necessary...', DATE'1970-01-02', TIMESTAMP'1991-01-02 00:00:02', TIMESTAMP WITH TIME ZONE'1991-01-02 00:00:02 -02:00', TIMESTAMP'1991-01-02 00:00:02.123456 -02:00',  TIMESTAMP WITH TIME ZONE'1991-01-02 00:00:02.123456 -02:00',22345678901234567890123456789012345678,22345678901234567890123456789.123456789,22345678.123456789012345678901234567890),
(3,3,3,3 ,12345678901234567890,1234567890123456789012345,123.3,123456.3,12345678.3 ,'xyx','C ','when in the course of human events it becomes necessary...', DATE'1970-01-03', TIMESTAMP'2030-01-03 00:00:03', TIMESTAMP WITH TIME ZONE'2030-01-03 00:00:03 -03:00', TIMESTAMP'2030-01-03 00:00:03.123456 -03:00',  TIMESTAMP WITH TIME ZONE'2030-01-03 00:00:03.123456 -03:00',32345678901234567890123456789012345678,32345678901234567890123456789.123456789,32345678.123456789012345678901234567890);


-- Deleting eid 6 from Postgres, will keep in other platforms.
DELETE FROM pgctest."Test_Case" WHERE eid=6;

-- Changing last_name of eid 1 to Smith, will keep same in other platforms.
UPDATE pgctest."Test_Case" SET last_name = 'Smith' WHERE eid=1;

-- To test nulls, setting bio to empty string for eid